...
+(BOOL) isShowing{
    return [self shareInstance].hudIsShowing || [self shareInstance].hudView.alpha == 1;
}
    ...
    switch (self.hudType) {
        case WSProgressHUDTypeStatus: {
            ...
            if (string) {
                ...
                self.labelView.center = CGPointMake(hudCenterX + 15, hudCenterY);
                self.spinnerView.center = self.indefiniteAnimationView.center = self.indicatorView.center = CGPointMake(20, hudCenterY);
    ...
    switch (self.hudType) {
        case WSProgressHUDTypeStatus: {
            ...
            if (string) {
                ...
                WSProgressHUDDefaultWidth = stringWidth + 60; // indicationWidth = 40
                WSProgressHUDDefaultHeight = stringHeight + WSProgressHUDHeightEdgeOffset + 15;
